...
describe("POST /usuarios", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      userData: { nome: "JoÃ£o Silva", email: "email-invalido", senha: "senha123" },
      expectedDetail: "O email é inválido.",
    },
    {
      name: "email is missing",
      userData: { nome: "JoÃ£o Silva", senha: "senha123" },
      expectedDetail: "O email é obrigatório.",
    },
    {
      name: "senha is less than 6 characters",
      userData: { nome: "JoÃ£o Silva", email: "joao@example.com", senha: "123" },
      expectedDetail: "A senha deve ter pelo menos 6 caracteres.",
    },
    {
      name: "senha is missing",
      userData: { nome: "JoÃ£o Silva", email: "joao@example.com" },
