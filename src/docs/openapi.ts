      ...
      Gasto: {
        ...
        properties: {
          ...
          competencia: {
            ...
            format: "date-time",
            nullable: true,
            description: "Mes de competencia do gasto. No frontend, a competencia acompanha o mes da data de vencimento.",
            example: "2026-08-01",
          },
          dataVencimento: {
            type: "string",
          ...
          observacao: {
            type: "string",
            nullable: true,
            description: "Observacoes e especificidades do lancamento informadas pelo usuario.",
            example: "Pagamento referente ao conserto do notebook",
          },
      ...
      CreateGastoRequest: {
        ...
        properties: {
          ...
          competencia: {
            ...
            format: "date-time",
            nullable: true,
            description: "Mes de competencia. A aplicacao usa o primeiro dia do mes do vencimento, por exemplo 2026-08-01 para vencimento em agosto/2026.",
            example: "2026-08-01",
          },
          dataVencimento: {
            type: "string",
          ...
          observacao: {
            type: "string",
            nullable: true,
            description: "Observacoes e especificidades opcionais informadas no cadastro do lancamento.",
            example: "Pagamento referente ao conserto do notebook",
          },
          categoriaId: { type: "string", format: "uuid" },
          cartaoCreditoId: { type: "string", format: "uuid", nullable: true },
        ...
        required: ["descricao", "tipo", "status", "origemLancamento", "valor", "dataVencimento", "categoriaId"],
      },
      UpdateGastoRequest: {
        type: "object",
        properties: {
          ...
          competencia: {
            ...
            format: "date-time",
            nullable: true,
            description: "Mes de competencia do gasto. Ao alterar o vencimento no frontend, este campo deve acompanhar o mes do novo vencimento.",
            example: "2026-08-01",
          },
          dataVencimento: {
            type: "string",
            format: "date-time",
            nullable: true,
            description: "Nova data de vencimento do gasto.",
            example: "2026-08-17",
          },
          dataPagamento: { type: "string", format: "date-time", nullable: true },
          observacao: {
            type: "string",
            nullable: true,
            description: "Observacoes e especificidades atualizadas do lancamento.",
            example: "Pagamento referente ao conserto do notebook",
          },
          categoriaId: { type: "string", format: "uuid" },
          cartaoCreditoId: { type: "string", format: "uuid", nullable: true },
